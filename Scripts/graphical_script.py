#############################################
__author__ = "Arun Puram"                  #
__LinkedIn__ = "Arun Puram"                #
__Github__ = "Afadeofred"                  #
#############################################
...
constants.password = "Enter your Linkedin Password"
...
def guibuild():
    ...
    link = "https://github.com/afadeofred/Linkedin_Connector_Bot.git"
    ...
    labe_head = Label(root, text="LinkedIn Connector Bot", fg="blue", font=fontstyle).grid(row=1, column=0)
    labe_des = Label(root, text="A bot to Target Mass connections with Recruiters", fg="blue",
    ...
    label2 = Label(root, text="for eg. to search for Commbank , BHP and Wipro Enter: ").grid(row=12, column=0)
    label3 = Label(root, text="Commbank;BHP;Wipro").grid(row=13, column=0)
    ...
    label_username = Label(root, text=" Connected Users list is exported to the csv file in Output Folder").grid(
        row=22, column=0)
    ...
    link = "https://www.linkedin.com/in/arunpuram"
    text = Text(root, height=1, padx=10, borderwidth=1, bg="cyan")
    text.insert(1.0, link)
    text.configure(state="normal")
    ...
    link = "https://github.com/arunpuram"
    text = Text(root, height=1, padx=10, borderwidth=1, bg="cyan")
    text.insert(1.0, link)
    text.configure(state="normal")
